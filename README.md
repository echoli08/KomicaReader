...
10. **響應式介面**：採用 Material Design 風格，提供流暢且直觀的使用者體驗

## 截圖預覽

<p align="center">
  <img src="Screenshot/Screenshot_20260102_101029_Komica Reader.jpg" height="400" />
  <img src="Screenshot/Screenshot_20260102_101032_Komica Reader.jpg" height="400" />
  <img src="Screenshot/Screenshot_20260102_101039_Komica Reader.jpg" height="400" />
  <img src="Screenshot/Screenshot_20260102_101049_Komica Reader.jpg" height="400" />
  <img src="Screenshot/Screenshot_20260102_101054_Komica Reader.jpg" height="400" />
</p>
...
1. **回文功能**：目前僅提供瀏覽體驗，回覆功能（包含圖文發佈）因驗證機制複雜，尚在尋找最穩定的實作方案。
2. **全文搜尋**：目前僅支援在載入的清單中進行關鍵字過濾，未來計畫加入跨板塊的全局搜尋。
3. **圖片下載**：在圖片預覽模式下直接將原圖儲存至手機相簿。

## 更新日誌

### V1.0.4 (2026-01-02)
- **新增功能**:
    - **日夜模式**: 支援日間/夜間模式切換，並會自動記憶使用者偏好。
    - **設定頁面**: 新增設定頁面入口與「關於軟體」說明視窗。
- **介面優化**:
    - **標題欄調整**: 將頂部標題欄高度降低並將標題文字置中，釋放更多閱讀空間。
    - **圖片顯示**: 討論串內取消縮圖顯示，改為直接載入原圖並自動調整寬度，提供更佳的瀏覽體驗。
    - **夜間模式配色**: 全面優化夜間模式下的文字與背景配色，解決部分文字無法辨識的問題。
    - **設定入口**: 將設定圖示移至標題欄左側，操作更直覺。
